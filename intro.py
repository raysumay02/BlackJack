...
def score_hand(hand):
    ...
    # only one ace can have value 11,  and this will reduce to 1 if
    # hand would bust
    score = 0
    ace = False
...
def reset_game():
    ...
    result_text.set("")
    # create the dealer and the player hands
    dealer_hand = []
    player_hand = []
    initial_deal()
...
card_frame = tk.Frame(main_Window, relief="sunken", borderwidth=1, background="green")
...
new_game_button = tk.Button(button_frame, text="New Game", command=reset_game)
